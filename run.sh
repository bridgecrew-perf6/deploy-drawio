...
SUPPORTED_TARGETS="drawio"

EXEC_CMD=""
EXEC_ITEMS_LIST=""

DEPLOY_ROOT=/mnt/hd320/servers
DRAWIO_DIR=drawio
DRAWIO_HOME=${DEPLOY_ROOT}/${DRAWIO_DIR}
...
deploy_drawio()
{
    ...
    then
        echoY "Already deployed drawio in ${DRAWIO_HOME}, check it there first!"
        exit 1
    else
        echoY "Deploying drawio..."
        cp -a ./src ${DRAWIO_HOME}
        echoG "drawio has been deployed successfully."
        cat ./src/README.md
    fi
}
